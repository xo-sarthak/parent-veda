...
/// Topic tags for a seed row, given their ids.
///
/// The ids stay English and stay here verbatim: they are what `inferTopics()`
/// produces, what a post row persists, and what related-post matching compares.
/// Resolving them through the one vocabulary (`kTopicNames`) rather than
/// writing pairs inline means a topic is translated in exactly one place, and
/// `test/community_bilingual_test.dart` can prove no seed uses an id the
/// vocabulary has never heard of.
List<LocalizedText> _topics(List<String> ids) => ids.map(topicNamed).toList();
...
final List<Community> kCommunities = [
  ...
  Community(
    ...
    members: 1284,
    auto: true,
    topics: _topics(['Pregnancy Symptoms', 'Labor', 'Nutrition']),
  ),
  Community(
    id: 'second_tri',
    ...
    members: 8640,
    auto: true,
    topics: _topics(['Pregnancy Symptoms', 'Brain Development']),
  ),
  Community(
    id: 'delhi_moms',
  ...
  Community(
    ...
    members: 12400,
    topics: _topics(['Pregnancy Symptoms', 'Labor', 'Breastfeeding']),
  ),
  Community(
    id: 'preg_nutrition',
  ...
  Community(
    ...
    members: 7100,
    topics: _topics(['Pregnancy Symptoms']),
  ),
  Community(
    id: 'preg_fitness',
    ...
    members: 4200,
    topics: _topics(['Pregnancy Fitness']),
  ),
  Community(
  ...
  Community(
    ...
    members: 5400,
    topics: _topics(['Brain Development']),
  ),
];
...
final List<CommunityPost> kSeedPosts = [
  ...
  CommunityPost(
    ...
    type: PostType.milestone,
    topics: _topics(['Labor', 'Breastfeeding']),
    likes: 264,
    comments: 52,
    saves: 73,
    endorsedBy: 'Dr. Meera',
  ...
  CommunityPost(
    ...
    type: PostType.question,
    topics: _topics(['Pregnancy Symptoms', 'Sleep']),
    likes: 73,
    comments: 33,
    saves: 7,
    wantsVerification: true,
...
///
/// `specialty` is a bilingual LABEL - authored seed copy with no user-creation
/// path, never persisted, never compared. (The thing that IS compared is
/// `CommunityPost.preferredSpecialty`, a lowercase key like 'gynae'; that stays
/// a plain String and must never be handed one of these.)
///
/// `cred` stays a String on purpose. IBCLC, OB-GYN, DNB, PsyD are awarded
/// credentials, not words - inventing a Hindi rendering would be inventing a
/// qualification. Where the credential is a job title rather than an acronym
/// ('Paediatrician', 'Sleep Consultant') it is still the string the doctor's
/// own registration will carry once real accounts exist, so it stays too.
typedef CommunityExpert = ({String name, String cred, LocalizedText specialty});
...
final List<CommunityExpert> kCommunityExperts = [
  (name: 'Dr. Meera Nair', cred: 'IBCLC', specialty: _t('Lactation', 'स्तनपान')),
  (name: 'Dr. Priya Sharma', cred: 'MD', specialty: _t('Pediatrics', 'बाल रोग')),
  (name: 'Dr. Ananya Rao', cred: 'OB-GYN', specialty: _t('Obstetrics', 'प्रसूति')),
  (name: 'Dr. Kavita Menon', cred: 'MD', specialty: _t('Gynaecology', 'स्त्री रोग')),
  (name: 'Dr. Sneha Iyer', cred: 'DNB', specialty: _t('Fetal Medicine', 'भ्रूण चिकित्सा')),
  (name: 'Dr. Riya Kapoor', cred: 'MD', specialty: _t('Neonatology', 'नवजात शिशु की देखभाल')),
  (name: 'Dr. Aarti Desai', cred: 'RD', specialty: _t('Prenatal Nutrition', 'गर्भावस्था में खानपान')),
  (name: 'Dr. Neha Bansal', cred: 'MD', specialty: _t('Pediatrics', 'बाल रोग')),
  // 'High Risk' is kept Latin the same way the community of that name does -
  // it is the phrase her own file and her doctor will use.
  (name: 'Dr. Pooja Reddy', cred: 'OB-GYN', specialty: _t('High-risk Pregnancy', 'High Risk गर्भावस्था')),
  (name: 'Dr. Shalini Verma', cred: 'IBCLC', specialty: _t('Breastfeeding', 'स्तनपान')),
  (name: 'Dr. Ritu Agarwal', cred: 'MD', specialty: _t('Obstetrics', 'प्रसूति')),
  (name: 'Dr. Divya Pillai', cred: 'PT', specialty: _t('Prenatal Fitness', 'गर्भावस्था में fitness')),
  (name: 'Dr. Sana Khan', cred: 'MD', specialty: _t('Gynaecology', 'स्त्री रोग')),
  (name: 'Dr. Tara Joshi', cred: 'PsyD', specialty: _t('Perinatal Mental Health', 'गर्भावस्था में मन की सेहत')),
  (name: 'Dr. Ishita Gupta', cred: 'DCH', specialty: _t('Child Health', 'बच्चों की सेहत')),
  (name: 'Dr. Lakshmi Subramanian', cred: 'MD', specialty: _t('Maternal Medicine', 'माँ की सेहत')),
  (name: 'Dr. Farah Ahmed', cred: 'IBCLC', specialty: _t('Lactation', 'स्तनपान')),
  (name: 'Dr. Megha Saxena', cred: 'OB-GYN', specialty: _t('Obstetrics', 'प्रसूति')),
  (name: 'Dr. Nandini Rao', cred: 'RD', specialty: _t('Nutrition', 'खानपान')),
  (name: 'Dr. Sweta Mishra', cred: 'MD', specialty: _t('Neonatology', 'नवजात शिशु की देखभाल')),
  (name: 'Dr. Aisha Sheikh', cred: 'DNB', specialty: _t('Gynaecology', 'स्त्री रोग')),
  (name: 'Dr. Vidya Hegde', cred: 'MD', specialty: _t('Pediatrics', 'बाल रोग')),
  // 'Pelvic' stays Latin: it is what a physiotherapist says to her in the room.
  (name: 'Dr. Charita Reddy', cred: 'PT', specialty: _t('Pelvic Health', 'Pelvic सेहत')),
  (name: 'Dr. Ramya Krishnan', cred: 'OB-GYN', specialty: _t('Fetal Medicine', 'भ्रूण चिकित्सा')),
];
...
// The Pulse strip itself is currently commented out on the Community screen
// (replaced by _ProPulseCard, kept for revert per comment-out-never-delete).
// The copy is translated anyway: a card that comes back English on the day the
// strip is switched back on is a defect nobody would think to look for.
//
// Numbers and percentages carry over EXACTLY - 127 stays 127, 68% stays 68%.
// A translated statistic that drifts is a lie the app tells quietly.
final List<PulseCard> kPulse = [
  PulseCard(
    type: PulseType.cohort,
    title: _t('You are not alone', 'आप अकेली नहीं हैं'),
    body: _t('127 mothers are also due in November 2026.',
        '127 और माँओं की डिलीवरी भी नवंबर 2026 में है।'),
  ),
  PulseCard(
    type: PulseType.poll,
    title: _t('Question of the week', 'इस हफ़्ते का सवाल'),
    body: _t('Have you started feeling regular kicks?',
        'क्या आपको अब नियमित हलचल महसूस होने लगी है?'),
    options: [
      _t('Yes', 'हाँ'),
      _t('Sometimes', 'कभी-कभी'),
      _t('Not yet', 'अभी नहीं'),
    ],
  ),
  PulseCard(
    type: PulseType.trending,
    title: _t('Trending discussion', 'इस समय सबसे ज़्यादा चर्चा में'),
    body: _t('Anyone else having back pain in Week 24?',
        'हफ़्ते 24 में और किसी को कमर दर्द हो रहा है?'),
    linkPostId: 'p1',
  ),
  PulseCard(
    type: PulseType.benchmark,
    title: _t('Cohort benchmark', 'आपके group का हाल'),
    body: _t('68% of mothers in your cohort have completed their anomaly scan.',
        'आपके group की 68% माँओं का anomaly scan हो चुका है।'),
  ),
  PulseCard(
    type: PulseType.expert,
    title: _t('Expert session', 'विशेषज्ञ के साथ session'),
    body: _t('Live tomorrow: Nutrition During the Third Trimester.',
        'कल live: तीसरी तिमाही में खानपान।'),
  ),
];
...
///
/// The keys of [_topicKeywords] are topic IDS, and the values are matched with
/// `contains()` against what she typed - neither is copy, and both are listed
/// in tool/hindi/_never_translate.tsv. Only the returned [LocalizedText] is
/// ever drawn; auto-tagging itself stays an English-only operation, which is
/// correct, because the id is the identity and identity does not translate.
///
/// (A Hindi post therefore auto-tags poorly - the keywords are English. That
/// was already true before this widening and is a content gap, not a bug the
/// type change introduces; it is listed in the handover rather than papered
/// over with a half-set of Hindi keywords.)
List<LocalizedText> inferTopics(String text) {
  final t = text.toLowerCase();
  final found = <LocalizedText>[];
  _topicKeywords.forEach((topic, keys) {
    if (keys.any(t.contains)) found.add(topicNamed(topic));
  });
...
final List<Community> kTtcCommunities = [
  ...
  Community(id: 'ttc_naturally', name: _t('Trying Naturally', 'क़ुदरती तरीक़े से कोशिश'), emoji: '', description: _t('The largest room, and the quietest. Months one to many - no advice unless it is asked for.', 'सबसे बड़ा कमरा, और सबसे शांत भी। पहला महीना हो या कई — जब तक कोई माँगे नहीं, कोई सलाह नहीं।'), members: 18600, auto: true, topics: _topics(['Cycles', 'Emotional'])),
  Community(id: 'ttc_first_month', name: _t('First Month', 'पहला महीना'), emoji: '', description: _t('Just started. Everything is new, and nobody here will tell you to relax.', 'अभी-अभी शुरुआत हुई है। सब कुछ नया है, और यहाँ कोई आपसे "बस relax कर लो" नहीं कहेगा।'), members: 5200, auto: true, topics: _topics(['Cycles'])),
  // --- Conditions ---
  Community(id: 'ttc_pcos', name: _same('PCOS'), emoji: '', description: _t('Cycles, weight, medication and what actually helps - from people living it.', 'मासिक चक्र, वज़न, दवाइयाँ और सच में क्या काम आता है — उन्हीं से जो यह रोज़ जी रहे हैं।'), members: 13400, topics: _topics(['PCOS', 'Nutrition'])),
  Community(id: 'ttc_endo', name: _same('Endometriosis'), emoji: '', description: _t('Pain, diagnosis, and the long road to being believed.', 'दर्द, diagnosis, और उस लंबे रास्ते की बात जहाँ जाकर कोई यक़ीन करता है।'), members: 6900, topics: _topics(['Endometriosis'])),
  Community(id: 'ttc_male', name: _t('Male Fertility', 'पुरुष fertility'), emoji: '', description: _t('Half the picture, and rarely talked about. Semen analyses, lifestyle, and what changed.', 'आधी तस्वीर, जिस पर बात कम ही होती है। Semen analysis, रोज़मर्रा की आदतें, और क्या बदला।'), members: 4800, topics: _topics(['Male fertility'])),
  // --- Treatment ---
  Community(id: 'ttc_ivf', name: _same('IVF'), emoji: '', description: _t('Preparing, cycles, transfers, waiting - and the costs nobody quotes upfront.', 'तैयारी, cycles, transfer, इंतज़ार — और वे खर्चे जो कोई पहले नहीं बताता।'), members: 11700, topics: _topics(['IVF'])),
  Community(id: 'ttc_iui', name: _same('IUI'), emoji: '', description: _t('A gentler first step. What to expect, and what it actually felt like.', 'एक नरम पहला क़दम। क्या उम्मीद रखें, और सच में कैसा लगा।'), members: 5100, topics: _topics(['IUI'])),
  // --- The hard rooms ---
  Community(id: 'ttc_loss', name: _t('Loss & Recovery', 'खोना, और उससे उबरना'), emoji: '', description: _t('Held gently. No timelines, no silver linings, no advice unless it is asked for.', 'यहाँ सब कुछ नरमी से थामा जाता है। कोई समय-सीमा नहीं, कोई "अच्छा ही हुआ" नहीं, और जब तक कोई माँगे नहीं, कोई सलाह नहीं।'), members: 7400, topics: _topics(['Loss', 'Emotional'])),
  Community(id: 'ttc_emotional', name: _t('Emotional Support', 'मन का सहारा'), emoji: '', description: _t('For the days that are simply hard, and the family gatherings that make them harder.', 'उन दिनों के लिए जो बस भारी होते हैं, और उन पारिवारिक समारोहों के लिए जो उन्हें और भारी कर देते हैं।'), members: 9300, topics: _topics(['Emotional'])),
  // --- Living well ---
  Community(id: 'ttc_nutrition', name: _t('Nutrition', 'पोषण'), emoji: '', description: _t('Indian kitchens, real food, no diet culture and no miracle powders.', 'भारतीय रसोई, असली खाना — न diet का दिखावा, न चमत्कारी powder।'), members: 8100, topics: _topics(['Nutrition'])),
  Community(id: 'ttc_partners', name: _t('Partner Lounge', 'साथी का कोना'), emoji: '', description: _t('For partners, in their own words. Not a support group for supporting her.', 'साथियों के लिए, उनके अपने शब्दों में। यह "उसका साथ कैसे दें" वाला group नहीं है।'), members: 3600, topics: _topics(['Partner'])),
  Community(id: 'ttc_ask_doctor', name: _t('Ask the Doctor', 'डॉक्टर से पूछिए'), emoji: '', description: _t('Verified specialists answer, publicly, so the answer helps more than one person.', 'जाँचे-परखे विशेषज्ञ खुलकर जवाब देते हैं, ताकि एक जवाब कई लोगों के काम आए।'), members: 15200, topics: _topics(['Medical'])),
];
...
final List<CommunityExpert> kTtcExperts = [
  // 'fertility' stays Latin throughout the TTC stage - the rooms above already
  // say 'पुरुष fertility', and it is the word couples use in the clinic.
  (name: 'Dr. Anjali Menon', cred: 'MD, Reproductive Medicine', specialty: _same('Fertility')),
  (name: 'Dr. Sandeep Rao', cred: 'MS, Andrology', specialty: _t('Male Fertility', 'पुरुष fertility')),
  (name: 'Dr. Kavya Nair', cred: 'MD, Obstetrics & Gynaecology', specialty: _same('PCOS')),
  (name: 'Dr. Ishita Bose', cred: 'Clinical Psychologist', specialty: _t('Fertility Counselling', 'Fertility में मन का सहारा')),
  (name: 'Dr. Rhea Kulkarni', cred: 'Fertility Nutritionist', specialty: _t('Nutrition', 'खानपान')),
  (name: 'Dr. Tanvi Shah', cred: 'MD, Reproductive Endocrinology', specialty: _same('IVF')),
];
...
final List<Community> kParentingCommunities = [
  ...
  Community(id: 'delhi_parents', name: _t('Delhi Parents', 'Delhi के माता-पिता'), emoji: '', description: _t('Local parents in Delhi NCR - paediatricians, daycares, classes and meetups.', 'Delhi NCR के माता-पिता — बच्चों के डॉक्टर, daycare, classes और मिलना-जुलना।'), members: 6400, auto: true, topics: _topics(['Health'])),
  // --- Recommended · the ages that come next ---
  Community(id: 'ones', name: _t('1 Year Olds', '1 साल के बच्चे'), emoji: '', description: _t('First steps, first words, first birthday - life with a one-year-old.', 'पहला क़दम, पहला शब्द, पहला जन्मदिन — एक साल के बच्चे के साथ ज़िंदगी।'), members: 11200, topics: _topics(['Milestones', 'Feeding'])),
  Community(id: 'twos', name: _t('2 Year Olds', '2 साल के बच्चे'), emoji: '', description: _t('Big feelings, big words and the famous twos - you are not alone.', 'बड़ी भावनाएँ, बड़े शब्द और वही मशहूर दो साल — आप अकेली नहीं हैं।'), members: 10600, topics: _topics(['Behaviour'])),
  Community(id: 'threes', name: _t('3 Year Olds', '3 साल के बच्चे'), emoji: '', description: _t('Preschool, endless “why?”, and a little person with big opinions.', 'Preschool, बार-बार का “क्यों?”, और एक छोटा सा इंसान जिसकी अपनी बड़ी राय है।'), members: 7300, topics: _topics(['Behaviour', 'Development'])),
  Community(id: 'toddlers', name: _t('Toddler Life', 'छोटे बच्चों की दुनिया'), emoji: '', description: _t('The 1–3 whirlwind - tantrums, milestones and tiny triumphs.', '1–3 साल का तूफ़ान — ज़िद, milestones और छोटी-छोटी जीतें।'), members: 13400, topics: _topics(['Behaviour', 'Development'])),
  // --- Topics that only matter once baby is here ---
  Community(id: 'first_foods', name: _t('Starting Solids', 'ऊपरी आहार की शुरुआत'), emoji: '', description: _t('First foods, weaning and fussy eating - recipes and reassurance.', 'पहला खाना, दूध छुड़ाना और खाने के नखरे — recipes भी, तसल्ली भी।'), members: 8900, topics: _topics(['Feeding'])),
  Community(id: 'baby_sleep', name: _t('Baby Sleep', 'शिशु की नींद'), emoji: '', description: _t('Regressions, naps and nights - gentle, no-judgement sleep support.', 'Regression, दिन की झपकी और रातें — नरम, बिना किसी टोका-टाकी के नींद का साथ।'), members: 12800, topics: _topics(['Sleep'])),
  Community(id: 'milestones', name: _t('Milestones & Development', 'पड़ाव और विकास'), emoji: '', description: _t('Rolling, sitting, crawling, talking - celebrate and compare notes.', 'करवट, बैठना, रेंगना, बोलना — जश्न भी मनाइए, अनुभव भी बाँटिए।'), members: 9100, topics: _topics(['Milestones', 'Development'])),
  Community(id: 'working_parents', name: _t('Working Parents', 'नौकरी करने वाले माता-पिता'), emoji: '', description: _t('Daycare, nannies, pumping and the juggle of going back to work.', 'Daycare, आया, pumping और काम पर लौटने की भागदौड़।'), members: 7600, topics: _topics(['Health'])),
  Community(id: 'potty', name: _same('Potty Training'), emoji: '', description: _t('When to start, what worked, and surviving the accidents.', 'कब शुरू करें, किसे क्या काम आया, और बीच के हादसों से कैसे निपटें।'), members: 4300, topics: _topics(['Behaviour'])),
  // --- Gender + more city groups (fine now that baby is here) ---
  Community(id: 'girl_moms', name: _t('Girl Moms', 'बेटियों की माँएँ'), emoji: '', description: _t('Raising girls - the giggles, the grit and everything in between.', 'बेटियों की परवरिश — खिलखिलाहट, हिम्मत, और बीच का सब कुछ।'), members: 9200, topics: _topics(['Behaviour'])),
  Community(id: 'mumbai_parents', name: _t('Mumbai Parents', 'Mumbai के माता-पिता'), emoji: '', description: _t('Local parents in Mumbai - paediatricians, daycares, classes and meetups.', 'Mumbai के माता-पिता — बच्चों के डॉक्टर, daycare, classes और मिलना-जुलना।'), members: 5300, topics: _topics(['Health'])),
];
...
final List<CommunityExpert> kParentingExperts = [
  (name: 'Dr. Ananya Rao', cred: 'Paediatrician', specialty: _t('Child Health', 'बच्चों की सेहत')),
  (name: 'Dr. Neha Sharma', cred: 'MD, Paediatrics', specialty: _t('Paediatrics', 'बाल रोग')),
  (name: 'Dr. Priya Menon', cred: 'IBCLC', specialty: _t('Lactation', 'स्तनपान')),
  (name: 'Dr. Kavita Reddy', cred: 'Paed. Nutritionist', specialty: _t('Infant Nutrition', 'शिशु का खानपान')),
  (name: 'Dr. Riya Kapoor', cred: 'Child Psychologist', specialty: _t('Behaviour', 'बर्ताव')),
  (name: 'Dr. Sneha Iyer', cred: 'Paediatric Physio', specialty: _t('Motor Development', 'शारीरिक विकास')),
  (name: 'Dr. Aarti Desai', cred: 'Sleep Consultant', specialty: _t('Infant Sleep', 'शिशु की नींद')),
  (name: 'Dr. Meera Nair', cred: 'Paediatrician', specialty: _t('Newborn Care', 'नवजात की देखभाल')),
  (name: 'Dr. Pooja Verma', cred: 'MD', specialty: _t('Paediatrics', 'बाल रोग')),
  (name: 'Dr. Farah Ahmed', cred: 'IBCLC', specialty: _t('Breastfeeding', 'स्तनपान')),
  (name: 'Dr. Divya Pillai', cred: 'Paediatric Dentist', specialty: _t('Teething', 'दाँत निकलना')),
  (name: 'Dr. Ritu Agarwal', cred: 'Developmental Paed', specialty: _t('Milestones', 'पड़ाव')),
];
...
final List<CommunityPost> kParentingPosts = [
  ...
  CommunityPost(
    ...
    type: PostType.expert,
    topics: _topics(['Milestones', 'Development']),
    stage: 'Parenting',
    likes: 172,
    comments: 24,
    saves: 118,
  ...
  CommunityPost(
    ...
    type: PostType.question,
    topics: _topics(['Feeding', 'Behaviour']),
    stage: 'Parenting',
    likes: 74,
    comments: 38,
    saves: 16,
  ...
  CommunityPost(
    ...
    type: PostType.experience,
    topics: _topics(['Development', 'Behaviour']),
    stage: 'Parenting',
    likes: 141,
    comments: 22,
    saves: 8,
  ...
  CommunityPost(
    ...
    type: PostType.question,
    topics: _topics(['Behaviour', 'Development']),
    stage: 'Parenting',
    likes: 79,
    comments: 36,
    saves: 13,
