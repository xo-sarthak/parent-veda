...
final Map<ReadyCategory, ReadyCatMeta> kReadyCatMeta = {
  ...
  ReadyCategory.partnerExtras: ReadyCatMeta(
      _t('Partner & extras', 'पार्टनर और बाक़ी'),
      _t('For your partner, and the nice-to-haves',
          'आपके पार्टनर के लिए, और वे चीज़ें जो अच्छी लगती हैं'),
...
final Map<String, LocalizedText> kWhyPack = {
  ...
  'partner_snacks': _t('Keeps your partner fuelled and steady beside you.', 'आपके पार्टनर को भूखा नहीं रहने देते, ताकि वे साथ टिके रहें।'),
  ...
  'partner_toiletries': _t('The basics, so your partner can freshen up too.', 'ज़रूरी चीज़ें, ताकि आपके पार्टनर भी ताज़ा हो सकें।'),
