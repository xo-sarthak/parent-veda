...
final List<Masterclass> kMasterclasses = [
  Masterclass(
    ...
    facts: [QuickFact(_t('90 min', '90 min'), _en('live')), QuickFact(_t('Sun 13 Jul', 'रवि 13 Jul'), _en('8:00 pm')), QuickFact(_t('Forever', 'हमेशा के लिए'), _en('recording'))],
    coaches: [
  ...
  Masterclass(
    ...
    facts: [QuickFact(_t('120 min', '120 min'), _en('recorded')), QuickFact(_t('On demand', 'जब चाहें'), _en('anytime')), QuickFact(_t('Forever', 'हमेशा के लिए'), _en('access'))],
    coaches: [
      Coach(_t('Deepti Sharma', 'Deepti Sharma'), _t('Doula & birth coach', 'Doula और birth coach'),
  ...
  Masterclass(
    ...
    facts: [QuickFact(_t('120 min', '120 min'), _en('live')), QuickFact(_t('Sat 26 Jul', 'शनि 26 Jul'), _en('6:00 pm')), QuickFact(_t('Forever', 'हमेशा के लिए'), _en('recording'))],
    coaches: [
  ...
  Masterclass(
    ...
    facts: [QuickFact(_t('75 min', '75 min'), _en('live')), QuickFact(_t('Wed 16 Jul', 'बुध 16 Jul'), _en('7:00 pm')), QuickFact(_t('Forever', 'हमेशा के लिए'), _en('recording'))],
    coaches: [
...
final List<YogaSession> kYogaSessions = [
  // Month 1
  YogaSession('yg_m1_settle', _t('Settling-in gentle flow', 'शुरुआत का सौम्य flow'), _t('12 min', '12 min'), _en('grounding'),
      ...
      month: 1),
  YogaSession('yg_m1_breath', _t('Breath awareness basics', 'साँस को पहचानने की बुनियाद'), _t('10 min', '10 min'), _en('breath'),
      ...
      month: 1),
  // Month 2
  YogaSession('yg_m2_nausea', _t('Ease for nausea days', 'मतली वाले दिनों की राहत'), _t('12 min', '12 min'), _en('relief'),
      ...
      month: 2),
  YogaSession('yg_m2_stretch', _t('Gentle full-body stretch', 'पूरे शरीर की सौम्य stretch'), _t('15 min', '15 min'), _en('opening'),
      ...
      month: 2),
  // Month 3
  YogaSession('yg_m3_hipsfound', _t('Hip-opener foundations', 'कूल्हे खोलने की बुनियाद'), _t('16 min', '16 min'), _en('opening'),
      ...
      month: 3),
  YogaSession('yg_m3_calm', _t('Calm & steady wind-down', 'शांत और ठहरा हुआ समापन'), _t('14 min', '14 min'), _en('calm'),
      ...
      month: 3),
  // Month 4
  YogaSession('yg_m4_energy', _t('Second-trimester energy flow', 'दूसरी तिमाही का ऊर्जा flow'), _t('18 min', '18 min'), _en('strength'),
      ...
      month: 4),
  YogaSession('yg_m4_posture', _t('Posture & alignment', 'मुद्रा और सीध'), _t('15 min', '15 min'), _en('align'),
      ...
      month: 4),
  // Month 5
  YogaSession('yg_m5_back', _t('Back-care essentials', 'कमर की देखभाल की ज़रूरी बातें'), _t('15 min', '15 min'), _en('relief'),
      ...
      month: 5),
  YogaSession('yg_m5_balance', _t('Steady balance & core', 'ठहरा संतुलन और core'), _t('16 min', '16 min'), _en('strength'),
      ...
      month: 5),
  // Month 6
  YogaSession('yg_m6_hips', _t('Hips & pelvis opener', 'कूल्हे और pelvis खोलने वाला क्रम'), _t('18 min', '18 min'), _en('opening'),
      ...
      month: 6),
  YogaSession('yg_m6_evening', _t('Gentle evening wind-down', 'शाम का सौम्य समापन'), _t('20 min', '20 min'), _en('calm'),
      _t('A soothing sequence to quiet the body and mind before sleep.', 'सोने से पहले शरीर और मन को शांत करने वाला सुकून भरा क्रम।'),
      month: 6),
  // Month 7
  YogaSession('yg_m7_hips', _t('Third-trimester hip release', 'तीसरी तिमाही में कूल्हों की जकड़न ढीली करना'), _t('18 min', '18 min'), _en('opening'),
      ...
      month: 7),
  YogaSession('yg_m7_back', _t('Lower-back relief', 'कमर के निचले हिस्से को राहत'), _t('15 min', '15 min'), _en('relief'),
      ...
      month: 7),
  YogaSession('yg_m7_breath', _t('Breathing for labour', 'लेबर के लिए साँस'), _t('12 min', '12 min'), _en('breath'),
      ...
      month: 7),
  // Month 8
  YogaSession('yg_m8_legsup', _t('Legs-up restorative', 'पैर ऊपर, पूरा आराम'), _t('10 min', '10 min'), _en('restore'),
      ...
      month: 8),
  YogaSession('yg_m8_pelvic', _t('Pelvic-floor & birth prep', 'Pelvic floor और जन्म की तैयारी'), _t('16 min', '16 min'), _en('prepare'),
      ...
      month: 8),
  YogaSession('yg_m8_evening', _t('Gentle evening wind-down', 'शाम का सौम्य समापन'), _t('20 min', '20 min'), _en('calm'),
      _t('A soothing sequence to quiet the body and mind before sleep.', 'सोने से पहले शरीर और मन को शांत करने वाला सुकून भरा क्रम।'),
      month: 8),
  // Month 9
  YogaSession('yg_m9_positions', _t('Labour positions practice', 'लेबर की मुद्राओं का अभ्यास'), _t('18 min', '18 min'), _en('prepare'),
      ...
      month: 9),
  YogaSession('yg_m9_breath', _t('Final breathing rehearsal', 'साँस की आख़िरी रिहर्सल'), _t('12 min', '12 min'), _en('breath'),
      ...
      month: 9),
  YogaSession('yg_m9_restore', _t('Deep rest & restore', 'गहरा आराम और बहाली'), _t('14 min', '14 min'), _en('restore'),
