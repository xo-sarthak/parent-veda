...
final List<ReadItem> kFatherReadItems = [
  ReadItem(
    id: 'f_baby_hears',
    title: _en('What Your Baby Can Hear at 20 Weeks'),
    type: ReadType.article,
    weekStart: 18,
    weekEnd: 24,
    priority: 'high',
    reason: _en('Your voice carries especially well now - here is why reading aloud matters.'),
    readingTime: _en('3 min'),
    category: _en('Bonding'),
    emoji: '👂',
    ...
    myth: _en('The baby cannot really hear me through the bump yet.'),
    fact: _en('By around 20 weeks the inner ear is working and low sounds - like your voice - reach your baby clearly.'),
  ),
  ReadItem(
    id: 'f_halfway',
    title: _en("She's Halfway - What's Changing for Her"),
    type: ReadType.article,
    weekStart: 18,
    weekEnd: 22,
    priority: 'high',
    reason: _en('Around week 20 she reaches the halfway point - here is how to show up.'),
    readingTime: _en('4 min'),
    category: _en('Supporting Her'),
    emoji: '🌗',
    body: _en('Around week 20 she reaches the halfway mark - a real milestone. Many mothers feel more energetic now, the bump becomes visible, and the first kicks often arrive.\n\n'
    ...
    whyThisMatters: _en('The halfway point is when pregnancy starts to feel real for many dads too. Knowing what is shifting for her - energy, body, the first kicks - lets you offer the specific, practical support that actually lands, instead of guessing.'),
    researchSimplified: _en('Around the mid-point many women report an energy rebound as early fatigue eases. Partner support is consistently linked to lower stress and better wellbeing in pregnancy, and practical help (chores, rest) reduces her load more than reassurance alone.'),
  ),
  ReadItem(
    id: 'f_anomaly_scan',
    title: _en('The 20-Week Scan - How to Be There for Her'),
    type: ReadType.article,
    weekStart: 18,
    weekEnd: 22,
    priority: 'high',
    reason: _en('The detailed anatomy scan is around now - your presence matters.'),
    readingTime: _en('4 min'),
    category: _en('Supporting Her'),
    emoji: '🔍',
    body: _en('The anomaly scan, usually around weeks 18–22, is a detailed look at how your baby is developing - heart, brain, spine, limbs and organs. It takes longer than earlier scans.\n\n'
    ...
    whyThisMatters: _en('Scan days carry quiet anxiety even when everything is fine. Being there - steady, prepared, unhurried - is one of the clearest ways to show up. It also means you hear the same information she does, so you can talk it through together afterwards.'),
  ...
  ReadItem(
    id: 'f_back_ache',
    title: _en('Why Her Back Aches Now - and What Helps'),
    type: ReadType.article,
    weekStart: 16,
    weekEnd: 30,
    priority: 'medium',
    reason: _en('Her centre of gravity is shifting - small, specific help lands big.'),
    readingTime: _en('3 min'),
    category: _en('Supporting Her'),
    emoji: '🤰',
    body: _en('As the bump grows, her centre of gravity shifts forward and her lower back takes the strain. By evening, it often aches.\n\n'
    ...
    whyThisMatters: _en('Back ache is one of the most common, most under-noticed strains of pregnancy. Spotting it before she has to ask turns "help" into care - and small, specific actions beat grand gestures every time.'),
    researchSimplified: _en('As the uterus grows, the centre of gravity shifts forward and the lower-back muscles work harder, which is why aching peaks by evening. Side-lying with a support pillow and gentle counter-pressure (a short massage) are commonly recommended, low-risk ways to ease it.'),
  ),
  ReadItem(
    id: 'f_first_kicks',
    title: _en('Feeling the First Kicks Together'),
    type: ReadType.article,
    weekStart: 18,
    weekEnd: 26,
    priority: 'medium',
    reason: _en('The first movements often arrive now - a moment to share.'),
    readingTime: _en('2 min'),
    category: _en('Bonding'),
    emoji: '👣',
    body: _en('Around now, the first flutters and kicks often arrive. At first they are faint - easy to miss - but they grow stronger over the coming weeks.\n\n'
    ...
    researchSimplified: _en('First movements (quickening) are usually felt by the mother before they are strong enough to feel from outside; external kicks tend to become palpable a few weeks later. Babies often still when they sense new pressure, then resume - so patience, not force, is the trick.'),
  ),

  // ---- Research Summaries -------------------------------------------------
  ReadItem(
    id: 'f_res_voice',
    title: _en('The Science of Talking to the Bump'),
    type: ReadType.research,
    weekStart: 16,
    weekEnd: 40,
    priority: 'medium',
    reason: _en('What the evidence actually says about prenatal bonding through sound.'),
    readingTime: _en('4 min'),
    category: _en('Research'),
    emoji: '🔬',
    body: _en('Prenatal hearing is one of the better-studied parts of fetal development, and the findings are surprisingly practical for dads.\n\n'
    ...
    whyThisMatters: _en('It reframes "talking to the bump" from something that feels awkward into something with a real, measurable payoff - a head start on the bond and on soothing your newborn.'),
    researchSimplified: _en('Fetal heart-rate and newborn-behaviour studies consistently show recognition of pre-birth sounds. Low frequencies penetrate best, and repetition is the active ingredient. Practically: pick one short thing and repeat it daily.'),
  ),
  ReadItem(
    id: 'f_res_dads',
    title: _en('What the Research Says About Dads in Pregnancy'),
    type: ReadType.research,
    weekStart: 12,
    weekEnd: 40,
    priority: 'medium',
    reason: _en('Involved partners measurably change how pregnancy goes for her.'),
    ...
    whyThisMatters: _en('If you have ever wondered whether your involvement really moves the needle, the evidence says it does - and it tells you where to spend your effort.'),
    researchSimplified: _en('Across studies, partner support tracks with lower stress, better care engagement and wellbeing. The effective inputs are practical and emotional support plus appointment attendance - not grand gestures.'),
  ),

  // ---- Book Summaries -----------------------------------------------------
  ReadItem(
    id: 'f_book_handbook',
    title: _en("We're Pregnant! The First-Time Dad's Pregnancy Handbook"),
    type: ReadType.book,
    weekStart: 4,
    weekEnd: 40,
    priority: 'medium',
    reason: _en('A week-by-week, no-jargon field guide written dad-to-dad.'),
    readingTime: _en('Book · 5 min summary'),
    category: _en('Book Summary'),
    emoji: '📗',
    author: 'Adrian Kulp',
    rating: 4.6,
    ratingCount: 4200,
    why: _en('Warm, funny and practical - it treats the dad as a real participant, not a bystander, with concrete things to do each week.'),
    body: _en('A week-by-week companion that walks a first-time father from positive test to delivery room. Each stage pairs what is happening for her and the baby with a short, doable list of ways to help.\n\n'
  ...
  ReadItem(
    id: 'f_book_dude',
    title: _en("Dude, You're Gonna Be a Dad!"),
    type: ReadType.book,
    weekStart: 4,
    weekEnd: 40,
    priority: 'medium',
    reason: _en('A quick, encouraging primer for the newly-terrified dad-to-be.'),
    readingTime: _en('Book · 4 min summary'),
    category: _en('Book Summary'),
    emoji: '📘',
    author: 'John Pfeiffer',
    rating: 4.5,
    ratingCount: 3100,
    why: _en('Short, blunt and encouraging - good for the dad who wants the essentials without a 300-page textbook.'),
    body: _en('A fast, confidence-building read that covers the essentials: what she is going through, what the appointments mean, how to prepare practically and financially, and how to be useful in the delivery room.\n\n'
