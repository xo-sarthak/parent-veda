...
class RecipePageScreen extends StatelessWidget {
          ...
          children: [
            ...
            _pad(Row(children: [
              Container(
                ...
                child: Text("Right for ${ChildProfileStore.instance.nameMid}'s stage", style: ppBody(11, color: ppPurple, w: FontWeight.w700)),
              ),
  ...
  Widget _customise(BuildContext context) => Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          const SizedBox(height: 6),
          Text('Make the same dish safe and easy for a younger one - ${ChildProfileStore.instance.nameMid} will be ready around 8 months.',
