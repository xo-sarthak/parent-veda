...
const List<RecipeItem> kRecipes = [
  ...
  RecipeItem(id: 'curdrice', title: 'Curd rice, travel-friendly', subtitle: _stage, minutes: 5, meal: 'Lunch', category: 'Travel', veg: true, kcal: 160, protein: 5, fibre: 1, recommended: true, description: 'Cooling, probiotic and no-cook - the easiest thing to carry for a day out.'),
  ...
  RecipeItem(id: 'vegpulao', title: 'Veg pulao, soft', subtitle: _stage, minutes: 25, meal: 'Lunch', category: 'Lunch', veg: true, kcal: 200, protein: 6, fibre: 4, description: 'A gentle one-pot with soft-cooked veg - mild spice, easy to mash.'),
  RecipeItem(id: 'dalrice', title: 'Soft dal rice', subtitle: _stage, minutes: 20, meal: 'Lunch', category: 'Lunch', veg: true, kcal: 180, protein: 7, fibre: 3, description: 'The everyday staple - complete protein, soft and comforting.'),
  ...
  RecipeItem(id: 'smoothie', title: 'Ragi & banana smoothie', subtitle: _stage, minutes: 5, meal: 'Snack', category: 'Beverages', veg: true, kcal: 140, protein: 4, fibre: 3, healthier: true, description: 'A sippable iron + calcium boost for fussy-appetite days.'),
  RecipeItem(id: 'tomatosoup', title: 'Tomato & carrot soup', subtitle: _stage, minutes: 20, meal: 'Snack', category: 'Soups & salads', veg: true, kcal: 90, protein: 3, fibre: 2, description: 'Smooth, warm and vitamin-A rich - sip from a cup or spoon.'),
  ...
  RecipeItem(id: 'chickensoup', title: 'Clear chicken soup', subtitle: _stage, minutes: 30, meal: 'Lunch', category: 'Soups & salads', veg: false, kcal: 110, protein: 10, fibre: 1, description: 'A light, nourishing broth - gentle protein and warmth.'),
  ...
  RecipeItem(id: 'prunepuree', title: 'Stewed prune & apple purée', subtitle: 'Natural fibre to get things moving', minutes: 12, meal: 'Snack', category: 'Snacks', veg: true, kcal: 90, protein: 1, fibre: 5, situation: 'Constipation', description: 'Gentle natural fibre to ease constipation.'),
  ...
  RecipeItem(id: 'bananarice', title: 'Banana & rice mash', subtitle: 'Binding and gentle', minutes: 8, meal: 'Snack', category: 'Snacks', veg: true, kcal: 110, protein: 2, fibre: 2, situation: 'Loose motion', description: 'Binding, bland and soothing when his tummy is upset.'),
  RecipeItem(id: 'coconutwater', title: 'Tender coconut water', subtitle: 'Rehydrates gently', minutes: 2, meal: 'Drink', category: 'Beverages', veg: true, kcal: 45, protein: 0, fibre: 0, situation: 'Loose motion', description: 'Natural electrolytes to keep him hydrated.'),
  RecipeItem(id: 'rasam', title: 'Soft tomato rasam', subtitle: 'Warm and soothing', minutes: 20, meal: 'Soup', category: 'Soups & salads', veg: true, kcal: 70, protein: 2, fibre: 1, situation: 'Cough & cold', description: 'Warm, mildly spiced and comforting for a blocked nose.'),
  ...
  RecipeItem(id: 'moongwater', title: 'Moong dal water', subtitle: 'Light, nourishing sips', minutes: 15, meal: 'Soup', category: 'Soups & salads', veg: true, kcal: 60, protein: 3, fibre: 1, situation: 'Fever', description: 'Thin, protein-light sips for when appetite drops.'),
...
List<RecipeItem> normalRecipes({bool? veg, String category = 'All'}) => kRecipes
    .where((r) => r.situation == null)
    .where((r) => veg == null || r.veg == veg)
