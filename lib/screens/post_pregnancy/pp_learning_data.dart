...
const List<LearningProgram> kLearningPrograms = [
  ...
  LearningProgram(
    ...
    covers: [
      'Why sleep cycles mature at 4 months - the science, simply.',
      'The link between Leap 4 and the sleep regression.',
      'Building a wind-down routine that actually sticks.',
  ...
  LearningProgram(
    ...
    kind: LearningKind.masterclass,
    instructorId: 'kabir',
    title: 'Understanding the Wonder Weeks',
    subtitle: 'The science of the fussy leaps, in plain, reassuring language.',
    topics: ['Development'],
    accent: _violet,
    price: '₹2,499',
    status: LearningStatus.available,
    durationLabel: '2 hr',
    about:
        'A recorded masterclass that translates the science of the Wonder Weeks into plain language, so you stop panicking about every fussy phase and start reading the leaps.',
    rating: 4.8,
    reviewsLabel: '410 parents',
    covers: [
      'What a "leap" is, and why fussiness spikes.',
      'The mental leaps from birth to 20 months.',
      'How to support - not push - each one.',
      'Telling a leap apart from something to watch.',
    ],
    recency: 78,
  ),
  LearningProgram(
